...
urlpatterns = [
    ...
    path("<int:pk>/records/add/", views.add_medical_record, name="record_add"),
    path("<int:pk>/vaccinations/add/", views.add_vaccination, name="vaccination_add"),
    path("<int:pk>/medications/add/", views.add_medication, name="medication_add"),
    path("<int:pk>/appointments/open/", views.appointment_open, name="appointment_open"),
