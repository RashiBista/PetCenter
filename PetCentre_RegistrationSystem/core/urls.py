...
urlpatterns = [
    ...
    path('appointments/<int:appointment_id>/mark-paid/', views.mark_payment_paid_view, name='mark_payment_paid'),
    ...
    path('geocode/search/', views.geocode_search_view, name='geocode_search'),
    ...
    path('dashboard/admin/stats/', views.admin_dashboard_stats_view, name='admin_dashboard_stats'),
